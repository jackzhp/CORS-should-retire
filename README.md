 CORS should retire, Adobe’s Approach should be adopted
...
this version with some typo corrected, and some minor editing
...
To meet the cross origin needs of web developers from then and now, the simplest solution is for http://1st.com/a.html to instruct browsers to deem http://2nd.com/ as same origin either with or with an http header(I would suggest to allow multiples). This directive mechanism is asymmetric since this directive does not imply http://2nd.com/ also deems http://1st.com/ as same origin.
